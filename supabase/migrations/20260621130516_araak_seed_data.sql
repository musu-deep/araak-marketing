...
- 9 أعضاء فريق مع أدوارهم وألقابهم
- 8 أقسام/تخصصات
...
INSERT INTO public.team_members (id, full_name, email, title, role_key, department_id, bio, specialties, is_active) VALUES
  ...
  ('22222222-0000-0000-0000-000000000003', 'أ. هاني محمد', 'hani.mohammed@araak.com', 'نائب الرئيس للاستثمار ومسؤول فريق التسويق', 'marketing_lead', '11111111-0000-0000-0000-000000000002', 'نائب الرئيس للاستثمار ومسؤول فريق تسويق المشاريع، يتولى متابعة المنصة واستقطاب المشاريع وإسناد المهام', ARRAY['الاستثمار','التسويق','إدارة المنافسات','إسناد المهام'], true),
